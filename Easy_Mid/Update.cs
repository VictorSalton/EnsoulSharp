        ...
        public static void Check()
        {
            try
            {
                using (var wb = new WebClient())
                {
                    ...
                    {
                        Chat.Print("<font color=\"#ff0000\">Easy_Mid is outdated! Please update to {0}!</font>", raw);
                    }
                    else
                        Chat.Print("<font color=\"#ff0000\">Easy_Mid is updated! Version : {0}!</font>", Version.ToString());
                }
