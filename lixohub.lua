...
--------------------------------------------------------------------
local Library = Update:Window("TSUO HUB ","")
------------------------------------------
...
--------------------------
local Main = Library:Tab("Menu 🇧🇷","rbxassetid://11446825283")
local Setting = Library:Tab("Configurações⚙️","rbxassetid://11446835336")
local Weapon = Library:Tab("Espadas⚔️ | Missões📜","rbxassetid://11446859498")
local Race = Library:Tab("Raça V4🐰","rbxassetid://11446900930")
local Stats = Library:Tab("Status📃","rbxassetid://11447069304")
local P = Library:Tab("Player🙎","rbxassetid://11446900930")
local Teleport = Library:Tab("Teleporte🏰","rbxassetid://11446920523")
local Dungeon = Library:Tab("Raid⚡","rbxassetid://11446957539")
local DevilFruit = Library:Tab("Fruta+Esp🍎","rbxassetid://11446965348")
local Shop = Library:Tab("Loja🛒","rbxassetid://6031265976")
local Misc = Library:Tab("outros❓","rbxassetid://11447063791")
local Op = Library:Tab("Status🔥", "rbxassetid://7040410130")
--------------------------------------------------------------------

Setting:Label("⚡ENTRE NO MEU DISCORD TSUO COMUNNITY!!⚡")

Setting:Line()

Setting:Button("🔥COPIAR LINK DO DISCORD🔥",function()
 
 setclipboard("https://discord.gg/fH4yPUBZMP")
 end)

Setting:Seperator(" Configurações ⚙️ ")
...
Setting:Toggle("Ant AFK",true,function(value)
 _G.AFK = value
 end)
...
Setting:Dropdown("Selecionar Método de Farm", {
 "Behind","Below","Upper"
},function(value)
 _G.Method = value
end)
...
Setting:Toggle("Juntar npcs [Normal]",true,function(value)
...
Setting:Toggle("Juntar npcs[PRO]",false,function(value)
 _G.BringExtra = value
end)
...
Setting:Toggle("Ataque Rápido [FAST ATACK]",true,function(value)
 _G.FastAttack = value
end)
...
Setting:Toggle("Auto haki do armamento",_G.Auto_Ken,function(vu)
	_G.Auto_Ken = vu
end)
spawn(function()
	while wait(2) do
...
Setting:Toggle("Tirar Efeito de Dano",_G.DisableDamage,function(value)
...
Setting:Toggle("Tela branca [+FPS ]",_G.WhiteScreen,function(value)
 ...
 game:GetService("RunService"):Set3dRenderingEnabled(true)
    ...
    Setting:Button("Gráficos De Batata🥔 [+FPS]",function()
        pcall(function()
...
Setting:Seperator(" Configurações De Maestria ")
...
local SelectWeapona = Main:Dropdown("Selecionar Arma",WeaponList,function(value)
 _G.Select_Weapon = value
 end)

Main:Button("Atualizar Armas",function()
 SelectWeapona:Clear()
 for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
...
Main:Button("Parar Teleporte",function()
  topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
  _G.Clip = false
  end)

Main:Seperator("  @TSUOSCRIPTS NO YOUTUBE 🇧🇷")

Main:Dropdown("Selecionar Modo de  Farm", {
 "Level Farm","Fast Mode","No Quest","Near Farm Mode"
},function(value)
 _G.Select_Mode_Farm = value
end)

Main:Toggle("Auto Farm ",_G.Auto_Farm_Level,function(value)
...
Main:Seperator("Auto Sea 3")

Main:Toggle("Auto Sea 3",_G.Auto_Third_World,function(value)
 _G.Auto_Third_World = value
 StopTween(_G.Auto_Third_World)
 end)

Main:Seperator("Ectoplasma")

Main:Toggle("Auto Farmar Ectoplasma",_G.Auto_Farm_Ectoplasm,function(value)
...
Main:Toggle("Auto Farmar Factory",_G.AutoFactory,function(value)
...
Main:Seperator("Auto Sea 2")

Main:Toggle("Auto Segundo Sea",_G.Auto_New_World,function(value)
...
Main:Seperator(" outros ")

Main:Dropdown("Selecionar Monstros", tableMon, function(vu)
 SelectMonster = vu
 end)

Main:Toggle("Farmar Monstros Selecionados",_G.AutoFarmSelectMonster,function(vu)
...
Main:Seperator(" Maestria 🇧🇷")
 
Main:Toggle("Auto Maestria De Fruta🍎",_G.AutoFarmFruitMastery,function(value)
 ...
 Main:Toggle("Auto Maestria De Arma🔫",_G.AutoFarmGunMastery,function(value)
...
local Boss = {}
    ...
    local BossName = Main:Dropdown("Selecionar Boss",Boss,function(value)
       _G.Select_Boss = value
    end)
    
    Main:Button("Reiniciar Bosses ",function()
        BossName:Clear()
            for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
            if string.find(v.Name, "Boss") then
                BossName:Add(v.Name) 
...
Main:Toggle("Auto Farmar Boss",_G.Auto_Farm_Boss,function(value)
 _G.Auto_Farm_Boss = value
 end)

Main:Toggle("Auto Pegar Missão De Boss",true,function(value)
...
Main:Toggle(" Farmar Todos os Bosses ",_G.Auto_Farm_All_Boss,function(value)
...
Main:Seperator(" Materiais⚙️")
 
 local SelectMaterial = Main:Dropdown("Select Material",MaterialMethod,function(value)
 _G.SelectMaterial = value
end)

Main:Toggle("Farmar  Material Selecionado",_G.AutoFarmMaterial,function(t)
...
Main:Seperator(" Ilha Da Miragem 🏝️ | TSUO SCRIPTS |")

Main:Toggle("Auto Miragem 🏝️",false,function(value)
...
Main:Toggle("Auto Miragem Hop",false,function(value)
 _G.Mystichop = value
end)

Main:Seperator(" Baú📦 ")

Main:Toggle("Auto Pegar Baú Rápido",false,function(vu)
	_G.ChestBypass = vu
end)
...
Main:Toggle(" Teleportar Para os Baús Manualmente",_G.Grab_Chest,function(vu)
	Grab_Chest = vu
    StopTween(Grab_Chest)
	_G.Grab_Chest = vu
end)

Main:Button("Teleporte Instantâneo Para Os Baús (Risk)",function()
...
Main:Toggle("Auto Farmar Bones🦴",_G.Auto_Farm_Bone,function(value)
 _G.Auto_Farm_Bone = value
 StopTween(_G.Auto_Farm_Bone)
 end)

Main:Toggle("Auto Trocar Bones🦴",_G.Auto_Trade_Bone,function(value)
...
Main:Button("Quantos Bones Eu Tenho❓", function()
...
Main:Seperator(" Haki da observação👀 ")
...
spawn(function()
	while game:GetService("RunService").Heartbeat:wait() do
       ...
       Main:Toggle("Auto Farmar Haki Da Observação",_G.AutoObservation,function(value)
    ...
    Main:Toggle("Auto Farmar Haki da Observação Hop",_G.AutoObservation_Hop,function(value)
...
wait(1)
Notification:Notify(
   {Title = "TSUO HUB", Description = "You Have Max Observation"},
   {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "option"},
   {Image = "https://i.pinimg.com/564x/08/25/06/082506876327d31cb742bdfa55ebef87.jpg", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
)
                    else
                        if World2 then
...
Main:Seperator(" Fake Transformações Da Raça V4🐰")


Main:Button("Mink Fake Transformação",function()
...
Main:Button("Fishman Fake Transformação",function()
...
Main:Button("Skypeian Fake Transformação",function()
...
Main:Button("Ghoul Fake Transformação",function()
...
Main:Button("Cyborg Fake Transformação",function()
...
Main:Button("Human Fake Transformação",function()
...
Main:Button("Fake Mink Dash Animação",function()
 local ReplicatedStorage = game:GetService("ReplicatedStorage")
...
Weapon:Seperator(" Missões📜 | TSUO SCRIPTS |")
...
local Elite_Hunter_Status = Weapon:Label("Status")
	...
	spawn(function()
		while wait() do
			Total_Elite_Hunter:Set("Total De Elite Hunter Que Matei : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
		end
	end)
...
Weapon:Toggle("auto farmar katakuri",_G.Auto_Cake_Prince,function(value)
...
StopTween(_G.Auto_Cake_Prince)
	...
	Weapon:Toggle("Auto Entrar Na Dimensão Do Katakuri",_G.Auto_Open_Dough_Dungeon,function(value)
...
Weapon:Seperator(" Cursed Dual Katana⚔️ ")

Weapon:Toggle("Auto Missão Da CDK",_G.AutoCdk,function(value)
 _G.AutoCdk = value
end)
...
Weapon:Seperator(" Shanks🟥")

Weapon:Toggle("Auto Sabre",_G.AutoSaber,function(value)
				_G.AutoSaber = value
			end)
			
			Weapon:Toggle("Auto Sabre Hop",_G.AutoSaberHop,function(value)
...
Weapon:Seperator("  Bartilo 🟩")

Weapon:Toggle("Missão Do Bartilo ",_G.Auto_Bartilo_Quest,function(value)
 _G.Auto_Bartilo_Quest = value
StopTween(_G.Auto_Bartilo_Quest)
end)

Weapon:Seperator(" Raça V2 ")

Weapon:Toggle("Auto  Raça [V2]",_G.Auto_Evo_Race_V2,function(value)
...
Weapon:Seperator(" ESPADAS LENDÁRIAS DO BAIANO 😎 ")

Weapon:Toggle("Auto Comprar as Espadas Do Zoro",_G.AutoBuyLegendarySword,function(Value)
		...
		Weapon:Toggle("Auto Comprar Espadas Do Zoro Hop",_G.AutoBuySwordHop,function(Value)
...
Weapon:Seperator(" Hakis Coloridos🏳️‍🌈 ")

	Weapon:Toggle("Auto Comprar Cores De Haki ",_G.Auto_Buy_Enchancement,function(value)
...
StopTween(_G.Auto_Rengoku)
	...
	spawn(function()
		...
		Weapon:Seperator(" Swan Espadas ")

Weapon:Toggle("Auto Swan Espadas",_G.Auto_Swan_Glasses,function(value)
 _G.Auto_Swan_Glasses = value
StopTween(_G.Auto_Swan_Glasses)
end)


	Weapon:Toggle("Auto Swan Espadas Hop",_G.Auto_Swan_Glasses_Hop,function(value)
 _G.Auto_Swan_Glasses_Hop = value
	...
	Weapon:Toggle("Auto Dragon Tridente",_G.Auto_Dragon_Trident,function(value)
 _G.Auto_Dragon_Trident = value
StopTween(_G.Auto_Dragon_Trident)
end)

	
	Weapon:Toggle("Auto Dragon Tridente Hop",_G.Auto_Dragon_Trident_Hop,function(value)
...
elseif World3 then
	...
	Weapon:Seperator(" Boss Da Foice ☠️ ")

Weapon:Toggle("Auto Matar Boss Da Foice ",_G.Auto_Soul_Reaper,function(value)
 _G.Auto_Soul_Reaper = value
StopTween(_G.Auto_Soul_Reaper)
end)


Weapon:Toggle("Auto Boss Da Foice Hop",_G.Auto_Soul_Reaper_Hop,function(value)
...
StopTween(_G.Auto_Soul_Reaper_Hop)
	...
	spawn(function()
		...
		Weapon:Seperator(" Rainbow Haki🏳️‍🌈 ")
	
	Weapon:Toggle("Auto Haki  Rainbow",_G.Auto_Rainbow_Haki,function(value)
 _G.Auto_Rainbow_Haki = value
StopTween(_G.Auto_Rainbow_Haki)
end)

	
	Weapon:Toggle("Auto  Haki Rainbow Hop",_G.Auto_Rainbow_Haki_Hop,function(value)
...
StopTween(_G.Auto_Canvander_Hop)
	...
	spawn(function()
		...
		Weapon:Seperator(" Espadas Do Elefante 🐘")
	
	Weapon:Toggle("Auto Matar Elefante 🐘",_G.Auto_Twin_Hook,function(value)
 _G.Auto_Twin_Hook = value
StopTween(_G.Auto_Twin_Hook)
end)

	
	Weapon:Toggle("Auto Matar Elefante 🐘 Hop",_G.Auto_Twin_Hook_Hop,function(value)
...
StopTween(_G.Auto_Twin_Hook_Hop)
	...
	spawn(function()
		...
		Weapon:Seperator(" Arco Da Serpente 🐍 ")

Weapon:Toggle("Auto Arco Da Serpente 🐍",_G.Auto_Serpent_Bow,function(value)
 _G.Auto_Serpent_Bow = value
StopTween(_G.Auto_Serpent_Bow)
end)

	
	Weapon:Toggle("Auto Arco Da Serpente 🐍 Hop",_G.Auto_Serpent_Bow_Hop,function(value)
...
Weapon:Toggle("Auto Ativar as Tochas ",_G.Auto_Holy_Torch,function(value)
...
Weapon:Seperator(" Haki Da observação V2 ")

Weapon:Toggle("Auto Haki Da observação V2",_G.AutoObservationHakiV2,function(x)
...
Weapon:Seperator(" Musketeer Capacete")

Weapon:Toggle("Auto Musketeer Capacete",_G.Auto_Musketeer_Hat,function(value)
...
if World3 then
Race:Seperator("Raça V4🐰")
    
    Race:Button("Teleportar Para o Templo",function()
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    end)
    
Race:Button("Teleportar Para A Alavanca ",function()
  topos(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
end)

Race:Button("Teleporte Para o Acient One(NPC)",function()
  topos(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
end)
   
   Race:Button("Desbloquear Alavanca.", function()
...
Race:Button("Clock Acess.", function()
...
Race:Toggle("Disabled Inf Stairs", nil, function(value)
  ...
  Race:Button("Teleportar Pra Sala Ciborgue (ATIVAR SÓ NO TEMPLO!)",function()
  topos(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
  end)
  
  Race:Button("Teleportar Pra Sala Fish (ATIVAR SÓ NO TEMPLO!)",function()
  topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
  end)
  
  Race:Button("Teleportar Pra Sala  Ghoul  (ATIVAR SÓ NO TEMPLO!)",function()
  topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
  end)
  
  Race:Button("Teleportar Pra Sala Human (ATIVAR SÓ NO TEMPLO!)",function()
  topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
  end)
  
  Race:Button("Teleportar Pra Sala Mink(ATIVAR SÓ NO TEMPLO!)",function()
  topos(CFrame.new(29020.66015625, 14889.4267578125, -379.2682800292969))
  end)
  
  Race:Button("Teleportar Pra Sala Sky (ATIVAR SÓ NO TEMPLO!)",function()
  topos(CFrame.new(28967.408203125, 14918.0751953125, 234.31198120117188))
  end)
  
  Race:Line()
  
  Race:Button("Teleportar Pra Área Sem PVP (ATIVAR SÓ NO TEMPLO!)",function()
  topos(CFrame.new(28273.0859375, 14896.5078125, 157.42063903808594))
  end)
  
  Race:Button("Teleportar Pra Zona De PVP (ATIVAR SÓ NO TEMPLO!)",function()
  topos(CFrame.new(28766.681640625, 14967.1455078125, -164.13290405273438))
  end)
  end

Stats:Seperator(" Auto Status ")

Stats:Toggle("Auto Status Estilo De Luta ",_G.Auto_Stats_Melee,function(value)
...
Stats:Toggle("Auto Status Defesa",_G.Auto_Stats_Defense,function(value)
...
Stats:Toggle("Auto Status Espada ",_G.Auto_Stats_Sword,function(value)
...
Stats:Toggle("Auto Status Arma ",_G.Auto_Stats_Gun,function(value)
...
Stats:Toggle("Auto Status Fruta ",_G.Auto_Stats_Devil_Fruit,function(value)
...
Stats:Button("Resetar Status",function()
...
P:Toggle("Spectar Player",_G.Spectate_Player,function(value)
...
P:Toggle("Teleportar Para o  Player",_G.Teleport_to_Player,function(value)
...
P:Toggle("Auto Matar Player [estilo de luta]",_G.Auto_Kill_Player_Melee,function(value)
...
P:Toggle("Auto Matar Player [arma]",_G.Auto_Kill_Player_Gun,function(value)
...
Teleport:Seperator(" TELEPORTAR 🌍 ")
 
 Teleport:Button("Teleportar Pro Sea 1",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
  end)
 
 Teleport:Button("Teleportar Pro  Sea 2",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
 end)

 
 Teleport:Button("Teleportar Pro Sea 3",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
  end)
 
 Teleport:Button("Teleportar Pro Seabeast",function()
 ...
 Teleport:Seperator(" Ilhas")
 
 if World1 then
 Teleport:Dropdown("Selecionar ilhas ", {
  "WindMill",
  "Marine",
  "Middle Town",
  "Jungle",
 ...
 if World2 then
 Teleport:Dropdown("Selecionar Ilha", {
  "The Cafe",
  "Frist Spot",
  "Dark Area",
  "Flamingo Mansion",
 ...
 Teleport:Toggle("Teleporte",false,function(value)
 ...
 Teleport:Button("Teleporte Instantâneo",function()
		 _G.Instant = true
...
Dungeon:Dropdown("Selecionar Microchip",chip,function(value)
 _G.Select_Dungeon = value
end)

Dungeon:Toggle("Auto Comprar Microchip",_G.Auto_Buy_Chips_Dungeon,function(value)
...
Dungeon:Toggle("Auto Começar Raid",_G.Auto_StartRaid,function(value)
...
Dungeon:Toggle("Passar De ilha 🏝️",_G.Auto_Next_Island,function(value)
...
Dungeon:Toggle("Haki do Rei (Kill Aura) ",_G.Kill_Aura,function(value)
 _G.Kill_Aura = value  
end)
...
Dungeon:Toggle("Auto AWK",_G.Auto_Awake,function(value)
 _G.Auto_Awake = value 
end)
...
spawn(function()
  ...
  Dungeon:Button("Passar De Ilha manualmente 🏝️ ",function()
   pcall(function()
    if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
    topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5").CFrame*CFrame.new(0,70,100))
    elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4") then
...
Dungeon:Seperator("RAID LAW🇧🇷")

Dungeon:Toggle("Auto Comprar Microchip Raid Law ",_G.Auto_Buy_Law_Chip,function(value)
...
Dungeon:Toggle("Auto Começar Raid Law ",_G.Auto_Start_Law_Dungeon,function(value)
...
Dungeon:Toggle("Auto Matar o Law",_G.Auto_Kill_Law,function(value)
...
spawn(function()
 ...
 _G.SelectFruit = ""
 DevilFruit:Dropdown("Selecionar Fruta Pra Comprar na Loja ",FruitList,function(value)
  _G.SelectFruit = value
  end)
 
 DevilFruit:Toggle("Auto Comprar Fruta Da loja ",_G.AutoBuyFruitSniper,function(value)
  _G.AutoBuyFruitSniper = value
  end)
 
 DevilFruit:Seperator(" outros | Tsuo scripts |  ")
 
 DevilFruit:Dropdown("Selecionar Fruta Pra Comer ",FruitList,function(value)
  _G.SelectFruitEat = value
  end)
 
 DevilFruit:Toggle("Auto Comer Fruta ",_G.AutoEatFruit,function(value)
 ...
 DevilFruit:Toggle("Girar fruta automático",_G.Random_Auto,function(value)
 ...
 DevilFruit:Button("Girar Fruta Manualmente",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
  end)
 
 
 DevilFruit:Toggle("Auto Dropar Fruta ",_G.DropFruit,function(value)
  _G.DropFruit = value
  end)
 ...
 DevilFruit:Toggle("Auto armazenar Fruta ",_G.AutoStoreFruit,function(value)
 ...
 DevilFruit:Toggle("Juntar Frutas ",_G.BringFruit,function(value)
  _G.BringFruit = value
  pcall(function()
 ...
 DevilFruit:Toggle("Teleportar Pra Frutas Spawnadas ",false,function(value)
 _G.Grabfruit = value
end)
...
spawn(function()
 ...
 DevilFruit:Toggle("Juntar Todas as Frutas 75% Kick System",_G.BringFruitBF,function(value)
...
function UpdateIslandESP()
 ...
 DevilFruit:Seperator(" ESPS ")
  
if World2 then
		DevilFruit:Button("TP PRA FLOR VERMELHA",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
				if v.Name == "Flower2" then
				    topos(v.CFrame)
				end
		...
		DevilFruit:Button("TP PRA FLOR AZUL",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
				if v.Name == "Flower1" then
					topos(v.CFrame)
				end
	...
	DevilFruit:Toggle("ESP Baús 📦",false,function(a)
		ChestESP = a
		while ChestESP do wait()
			UpdateChestChams() 
		end
	end)
	DevilFruit:Toggle("ESP Frutas🍎",false,function(a)
		DevilFruitESP = a
		while DevilFruitESP do wait()
			UpdateDevilChams() 
		end
	end)
	DevilFruit:Toggle("ESP Flores🌹",false,function(a)
		FlowerESP = a
 ...
 Shop:Seperator(" Habilidades🥋  ")
 
 Shop:Button("Comprar Pulo Duplo ",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
  end)
 
 Shop:Button("Comprar Haki do Armamento",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
  end)
 
 Shop:Button("Comprar Teleporte instantâneo",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
  end)
 
 Shop:Button("Comprar Haki da Observação (Ken) Haki",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
  end)
 
 Shop:Seperator(" Estilos De Luta  ")
 
 Shop:Button("Comprar Black Leg",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
  end)
 
 Shop:Button("Comprar Electro",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
  end)
 
 Shop:Button("Comprar Fishman Karate",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
  end)
 
 Shop:Button("Comprar Dragon Claw",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
  end)
 
 Shop:Button("Comprar Superhuman",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
  end)
 
 Shop:Button("Comprar Death Step",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
  end)
 
 Shop:Button("Comprar Sharkman Karate",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
  end)
 
 Shop:Button("Comprar Electric Claw",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
  end)
 
 Shop:Button("Comprar Dragon Talon",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
  end)
 Shop:Button("Comprar GodHuman",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
  end)
 -----Shop----------------
 Shop:Seperator(" Acessórios ")
 ...
 Shop:Button("Girar Raça",function()
...
Misc:Button("Relogar no Mesmo servidor",function()
 local ts = game:GetService("TeleportService")
		local p = game:GetService("Players").LocalPlayer
		ts:Teleport(game.PlaceId, p)
end)

Misc:Button("Trocar De Servidor",function()
 hop()
end)
...
Misc:Button("Cor De Haki",function()
 game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
end)

Misc:Seperator(" Códigos ")
...
local x2Code = {
 ...
 "Enyu_is_Pro"
    ...
    Misc:Button("Resgatar Todos os Códigos",function()
    ...
    Misc:Dropdown("Selecionar código",{"1MLIKES_RESET","THIRDSEA","SUB2GAMERROBOT_RESET1","SUB2UNCLEKIZARU"},function(value)
        _G.CodeSelect = value
    end)
    
    Misc:Button("Resgatar Código Selecionado Code",function()
...
Misc:Toggle("Dodge No Cooldown",false,function(value)
    ...
    Misc:Toggle("Auto Ativar  Raça",_G.AutoAgility,function(value)
    ...
    Misc:Toggle("Velocidade De Mink",false,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    Misc:Toggle("Haki da Observação infinito",getgenv().InfiniteObRange,function(value)
    ...
    Misc:Toggle("Teleporte Infinito",getgenv().InfSoru,function(value)
    ...
    Misc:Toggle("andar na Água (FAMOSO JESUS)",true,function(value)
        _G.WalkWater = value
    end)
    
    if World2 then
		Misc:Button("Remover neblina",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
				if v.Name == "Lava" then   
					v:Destroy()
				end
...
spawn(function()
    ...
    Misc:Button("Desbloquear FPS",function()
        setfpscap(100)
    end)
